class window.PropositionEmbedYoutubeView extends Backbone.View
  ...
  play: ->
    ...
    theater.play "<iframe class='youtube-player' type='text/html' width='620' height='385' src='http://www.youtube.com/embed/#{@model.youtube}?autoplay=1' frameborder='0'></iframe>"
