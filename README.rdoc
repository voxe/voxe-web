...
If you have access to your staging server, you can also use the "heroku-mongo-sync" plugin to get the database we use on this server:

  heroku plugins:install http://github.com/pedro/heroku-mongo-sync.git
  heroku mongo:pull --app voxe-staging
